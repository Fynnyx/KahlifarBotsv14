    ...
    async execute(interaction, client) {
        ...
        switch(interaction.options.getSubcommand()) {
            case "news-template":
                ...
                let text = "";
                text = (await getCMSText("news-template"))[0].attributes.texts.forEach(element => {
                    text += element.value;
                });
